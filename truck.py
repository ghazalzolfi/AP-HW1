...
class Truck(Vehicle):
    def __init__(self, license_plate: str, fuel_capacity: float, current_load: float, transmission_type: str, price, weight, num_wheels):
        super().__init__(price, weight, num_wheels)
